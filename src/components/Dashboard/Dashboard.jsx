// components/dashboard/Dashboard.jsx - MOBILE RESPONSIVE
  ...
  return (
    <div className="group relative rounded-lg border border-[#E2E0D9] bg-white overflow-hidden transition-shadow hover:shadow-[0_4px_20px_-6px_rgba(30,36,32,0.15)]">
      ...
      <div className="px-3 md:px-4 py-3 space-y-2">
        <div className="flex items-center justify-between text-[11px] md:text-[12px] text-[#55605A]">
          <span className="flex items-center gap-1.5">
            <MapPin className="h-3 w-3 md:h-3.5 md:w-3.5 text-[#9A9488]" />
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          {pro.isVerified && (
            <span className="inline-flex items-center gap-1 rounded-[3px] bg-[#1E7A34]/10 px-2 py-[3px] text-[9px] md:text-[10px] font-semibold text-[#1E7A34] uppercase">
...
function MessagesTab({
  ...
  return (
    <div className="flex h-[calc(100vh-180px)] md:h-[calc(100vh-200px)] bg-white rounded-xl border border-[#E2E0D9] overflow-hidden">
      {/* Conversation List - Hidden on mobile when chat is open */}
      <div
        className={`${showChat ? "hidden" : "flex"} md:flex w-full md:w-[320px] border-r border-[#E2E0D9] flex-col`}
      >
      ...
      <div
        className={`${!showChat ? "hidden" : "flex"} md:flex flex-1 flex-col bg-[#FAFAF8]`}
      >
        {selectedChat ? (
          <>
            <div className="flex items-center justify-between px-4 md:px-5 py-3 md:py-4 bg-white border-b">
              ...
              <div className="flex items-center gap-1.5 px-2 md:px-3 py-1 md:py-1.5 rounded-full bg-[#F7F6F2] text-[10px] md:text-[11px] text-[#9A9488]">
            ...
            <div className="px-3 md:px-5 py-1.5 md:py-2 bg-[#FFF8F0] border-b border-[#F0821E]/10 flex items-center gap-2 text-[10px] md:text-[11px] text-[#B85E10]">
              <Shield className="h-3 md:h-3.5 w-3 md:w-3.5" />
            ...
            {warning && (
              <div className="mx-3 md:mx-4 mb-2 rounded-lg bg-red-50 border border-red-200 px-3 md:px-4 py-2 md:py-3 flex items-start gap-2">
                ...
                <p className="text-[11px] md:text-[12px] text-red-600">
                  {warning}
                </p>
                <button
                  onClick={() => setWarning("")}
            ...
            <div className="p-3 md:p-4 bg-white border-t">
              <div className="flex items-end gap-2 md:gap-3">
                ...
                <button
                  ...
                  className="rounded-xl bg-[#1E7A34] p-2.5 md:p-3 text-white hover:bg-[#166B2C] disabled:opacity-40"
                >
...
export default function Dashboard({
  ...
  return (
    <div className="min-h-screen w-full bg-[#F5F4F0] text-[#1E2420] font-['Inter',sans-serif] pb-16 md:pb-0">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:sticky top-0 z-50 h-screen w-[220px] bg-white border-r border-[#E2E0D9] flex-col justify-between px-4 py-6 transition-transform duration-300 md:translate-x-0 md:flex ${sidebarOpen ? "translate-x-0 flex" : "-translate-x-full hidden"}`}
      >
        <div>
      ...
      <main className="min-w-0 flex-1 px-4 md:px-8 py-4 md:py-8">
      ...
      {/* Mobile Bottom Nav */}
      <nav className="fixed inset-x-0 bottom-0 z-20 flex items-center justify-around border-t border-[#E2E0D9] bg-white/95 px-2 py-1.5 backdrop-blur md:hidden">
